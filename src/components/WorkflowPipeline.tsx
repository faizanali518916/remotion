...
export const WorkflowPipeline: React.FC<WorkflowPipelineProps> = ({ labels, delay = 0, accent = '#22d3ee' }) => {
	...
	return (
		...
		>
			...
			{labels.map((label, index) => {
				const reveal = interpolate(frame, [delay + index * 18, delay + index * 18 + 20], [0, 1], {
					...
					>
						<div
							style={{
								...
								background: 'radial-gradient(circle, rgba(255,255,255,0.18), rgba(15,23,42,0.86))',
