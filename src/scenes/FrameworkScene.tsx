  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", left: 150, right: 150, top: 248 }}>
        <WorkflowPipeline
          delay={28}
          labels={["Diagnose", "Structure", "Automate", "Practical AI"]}
          accent="#22d3ee"
        />
      </div>
      <div
          ...
          return (
            <GlassCard
              ...
              style={{
                ...
                transform: `translateY(${slideUp(frame, delay, 20, 34)}px) scale(${springScale(
                  frame,
                  fps,
                  delay,
                )})`,
            ...
            >
              <div style={{ color: "#67e8f9", fontSize: 20, fontWeight: 900 }}>
                {step.label}
              </div>
              <div
                style={{
              ...
              <div style={{ marginTop: 18, color: "#cbd5e1", fontSize: 20, lineHeight: 1.42 }}>
                {step.detail}
              </div>
            </GlassCard>
          );
