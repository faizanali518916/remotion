  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", top: 76, left: 130, right: 130, textAlign: "center" }}>
        <AnimatedText
          delay={0}
          style={{ fontSize: 64, lineHeight: 1.08, fontWeight: 850, letterSpacing: 0 }}
        >
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 18,
                  background:
                    "linear-gradient(135deg, rgba(34,211,238,0.36), rgba(139,92,246,0.24))",
                  border: "1px solid rgba(255,255,255,0.18)",
                  boxShadow: "0 0 34px rgba(34,211,238,0.2)",
                }}
              />
              <div style={{ marginTop: 28, color: "#67e8f9", fontSize: 24, fontWeight: 900 }}>
                {outcome.label}
              </div>
              <div
                style={{
              ...
              <div style={{ marginTop: 24, color: "#cbd5e1", fontSize: 20, lineHeight: 1.42 }}>
                {outcome.detail}
              </div>
            </GlassCard>
          );
