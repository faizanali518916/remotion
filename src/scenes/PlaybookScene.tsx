  ...
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", top: 78, left: 128, right: 128 }}>
        <AnimatedText
          delay={0}
          style={{ fontSize: 62, lineHeight: 1.08, fontWeight: 850, letterSpacing: 0 }}
        >
      ...
      <GlassCard
        ...
        style={{
          ...
          transform: `translateY(${slideUp(frame, 24, 24, 40)}px) scale(${springScale(
            frame,
            fps,
            20,
          )})`,
      ...
      >
        <div style={{ color: "#67e8f9", fontSize: 19, fontWeight: 900 }}>
          CUSTOM AI PLAYBOOK
        </div>
        <div
          style={{
